...
while True:
    ...
    originale=gray
    cv2.putText(frame, "[o|l]seuil: {:d}  [p|m]blur: {:d}".format(seuil, kernel_blur), (10, 30),
                cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 255), 2)
    cv2.putText(frame, "[i|k]surface: {:d}".format(surface), (10, 60), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 255),
                2)
